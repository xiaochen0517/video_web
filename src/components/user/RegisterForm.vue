    ...
    <div class="register-form">
        <el-form ref="loginFormRef" :label-position="labelPosition" label-width="100px" :model="formContent"
            ...
            <el-form-item label="邮箱：" prop="email">
                <el-input v-model="formContent.email" />
            </el-form-item>
            <el-form-item label="密码：" prop="password">
                <el-input type="password" v-model="formContent.password" />
            </el-form-item>
            ...
            <el-form-item class="button-group">
                <el-button class="login-button" type="default" @click="jumpToLogin">登录</el-button>
